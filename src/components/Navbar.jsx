...
const Navbar = () => {
  ...
  return (
    <div className="bg-white w-full h-[110px] lg:h-40 z-10 drop-shadow-md absolute overflow-auto">
      <div className="px-2 flex  items-center lg:mx-auto justify-between lg:w-8/12 h-full">
        <div className="flex items-center">
          <Image
            ...
            loading="lazy"
          />
          <ul className="hidden  md:-mx-[0.1px] text-sm font-semibold tracking-widest font-sofia gap-4 md:flex mx-28 justify-between">
            {Links.map((link) => (
              <li key={link.name}>
        ...
        <div className="hidden  md:flex font-sofia text-white gap-2">
